...
| **Claim** | After unlock, claim the Slice to USDC from Portfolio ([Slice to public asset](/investment/guides/from-slice-to-public-asset)) |

## Payouts and exits

- After a liquidity event and the lock-up on WLTH's position ends, open **Portfolio** and tap **Claim**. Proceeds land as **USDC**.
- You can keep the USDC, or swap into a **public ticker** (for example SPCX) on [ST0x](https://www.st0x.io/) rails. That step is optional.
...
The full path is in [From Slice to public asset](/investment/guides/from-slice-to-public-asset).
...
- [From Slice to public asset](/investment/guides/from-slice-to-public-asset)
